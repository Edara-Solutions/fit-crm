...
export const mockInventory: InventoryItem[] = [
  { id: 'inv-1', productId: 'p-1001', productName: 'FIT Whey Isolate 2kg', sku: 'BFX-WHY-2KG', stock: 124, lowStockThreshold: 20, expiryDate: '2027-02-20', lastUpdated: '2026-05-10' },
...
export const mockStockAdjustments: StockAdjustment[] = [
  { id: 'adj-1', productName: 'FIT Whey Isolate 2kg', type: 'add', quantity: 40, reason: 'Supplier delivery received', date: '2026-05-10', user: 'Karim Fathy' },
